...
LOCK TABLES `music_player` WRITE;
/*!40000 ALTER TABLE `music_player` DISABLE KEYS */;
INSERT INTO `music_player` VALUES (1,'koi vi nai','shirley setia','lyric','c:/music/shirley','created by shirley in 2017');
/*!40000 ALTER TABLE `music_player` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2019-12-09 15:51:04
